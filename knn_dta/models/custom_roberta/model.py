...
class DTIRobertaEncoder(FairseqEncoder):
    """RoBERTa encoder."""

    def __init__(self, args, dictionary, max_positions):
        super().__init__(dictionary)
        self.args = args
...
@register_model_architecture("custom_roberta", "custom_roberta")
...
@register_model_architecture("custom_roberta", "custom_roberta_base")
def roberta_base_architecture(args):
    base_architecture(args)


@register_model_architecture("custom_roberta", "custom_roberta_large")
...
@register_model_architecture("custom_roberta", "custom_xlm")
